...
<body>
    <section id="log_in">
        <div>
            <div class="row">
                <div class="left_area  col-md-6   p-0 d-none d-md-flex">
                    <div class="bg-black d-flex justify-content-center align-items-center col-12">
                    </div>
                    <div class="log_text container">
                        <h2 class=" fs-1 fw-bold" >Keep it special</h2>
                        <p class="fs-2  fw-bold my-4 ">Capture your personal memory in unique way, anywhere.</p>
                    </div>
                    <div class="social_media container-fluid">
                ...
                <div class="right_area col-md-6 d-flex justify-content-center align-items-center p-0">
                    <div class="bg-black d-flex d-md-none justify-content-center align-items-center col-12">
                    </div>
                    <div class="wrapper d-flex justify-content-center align-items-center">
                        <div class="row">
                            ...
                            {{-- <form class="col-9 m-0-auto">
                                ...
                                <button type="submit" class="btn btn-primary w-100 p-3 rounded-pill">Submit</button>
                            </form> --}}
                            <!-- Session Status -->
                            <x-auth-session-status class="mb-4" :status="session('status')" />
                            <!-- Validation Errors -->
                            <x-auth-validation-errors class="mb-4" :errors="$errors" />
                            <form class="col-9 m-0-auto" method="POST" action="{{ route('login') }}">
                                @csrf
                                <!-- Email Address -->
                                <div class="mb-3">
